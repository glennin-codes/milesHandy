      ...
      <Box maxWidth="sm" sx={{ my: 4, mx: "auto" }}>
        ...
        <div style={{ padding: '16px',height:'200px' }} {...getRootProps()}>
          ...
          {isDragActive ? (
            ...
            <em style={{color:"#FFBF00",marginTop:"5px"}}>Please select at least 5 images but a muximum of 10</em><br/>
            <em style={{color:"#FFBF00",marginTop:"5px"}}>Ensure that each image does not exceed 6.5MB in size</em><br/>
